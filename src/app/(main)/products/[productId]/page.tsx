    ...
    <div className="flex flex-col gap-y-gap-9">
      ...
      <div className="flex gap-x-gap-9">
        <div className="relative aspect-[1/1] flex-1">
          <Image
            src={"/images/porträt.jpg"}
            alt=""
            fill //hier fill -> display absolut
            className="object-[50%_50%] object-cover"
          />
        </div>
        <div className="relative aspect-[1/1] bg-gray-100 flex-1 ">
          <Image
            src={"/images/product-test.png"}
            alt=""
            fill //hier fill -> display absolut
...
export default function ProductPage() {
  return (
    <MainContainer>
      <div className="grid grid-cols-[576fr_560fr] gap-x-[64px] w-full">
        <ProductImages />
        <div>
          ...
          <div className="flex gap-x-gap-9 items-stretch mb-gap-9">
            ...
            <Button value={"fill"} size={"xl"} className="flex-1">
              ADD TO CART
            </Button>
          </div>
          <Button
          ...
          <ScrollArea type={"auto"} className="w-full mb-gap-13">
