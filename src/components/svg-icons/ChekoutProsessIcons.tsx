  ...
  return (
    ...
    >
      <path
        ...
        className="stroke-current group-data-[fill=true]:fill-gray-950 group-data-[fill=false]:fill-transparent"
      />
      <path
...
export { CheckoutAddressIcon, CheckoutPaymentIcon, CheckoutReviewIcon };
