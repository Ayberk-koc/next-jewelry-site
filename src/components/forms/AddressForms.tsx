...
import {
  ...
  CreateAddressFormValuesType,
  EditAddressFormValuesType,
} from "./addressFormSchemas";
...
function AddressForm() {
  const form = useFormContext<EditAddressFormValuesType>();

  function onSubmit(vals: EditAddressFormValuesType) {
    console.log(vals);
    return;
  }

  const method = form.handleSubmit(onSubmit);
...
function EditAddressFormProvider({
  initial,
  children,
}: {
  ...
  const form = useForm<EditAddressFormValuesType>({
...
function CreateAddressFormPrivoder({ children }: { children: ReactNode }) {
  const form = useForm<CreateAddressFormValuesType>({
...
export { EditAddressFormProvider, CreateAddressFormPrivoder, AddressForm };
